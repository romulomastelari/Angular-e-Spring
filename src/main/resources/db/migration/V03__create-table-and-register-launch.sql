...
INSERT INTO lancamento (descricao, data_vencimento, data_pagamento, valor, observacao, tipo, id_categoria, id_pessoa) values ('Conta do cartão', '2021-03-10', '2021-03-10', 400.00, 'Conta de luz referente ao mês de março', 'DESPESA', 5, 1);